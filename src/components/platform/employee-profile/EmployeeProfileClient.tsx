...
interface EmployeeProfileClientProps {
  employeeData: any; // Define a more specific type based on your data structure
  employeeId: string;
}
...
const EmployeeProfileClient: React.FC<EmployeeProfileClientProps> = ({ employeeData, employeeId }) => {
  ...
  if (!employee || employee.id === "default" || employee.id !== employeeId) {
    return (
      <PlatformLayout title="Employee Profile">
  ...
  return (
    <PlatformLayout title={`Profile: ${employee.name}`}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <Card>
              ...
              <CardContent>
                {employee.competencies.map((comp: any) => (
                  <div key={comp.competencyId} className="mb-4 p-3 border rounded-md">
                    ...
                    <Table>
                      ...
                      <TableBody>
                        {comp.assessmentResults.map((res: any, idx: number) => (
                          <TableRow key={idx}>
            ...
            <Card>
              ...
              <CardContent>
                {employee.currentEnrollments.map((enrollment: any) => (
            ...
            <Card>
              ...
              <CardContent>
                ...
                {employee.completedCourses.map((course: any) => (
          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <Card>
              ...
              <CardContent>
                {employee.recommendedCourses.map((course: any) => (
