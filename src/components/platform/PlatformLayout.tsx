...
// Higher-order component to protect platform routes
      ...
      <div className="w-64 bg-gray-900 text-white border-r border-gray-800 flex flex-col">
          ...
          <div className="mb-2">
            ...
            {learningExpanded && (
              <div className="pl-4">
                ...
                <Link href="/platform/assessments/custom-center" className="flex items-center px-4 py-3 hover:bg-gray-800 rounded-md">
        ...
        <div className="p-4 border-t border-gray-800">
          ...
          <button 
            ...
            className="mt-4 w-full flex items-center justify-center px-4 py-2 border border-red-500 text-red-500 rounded-md hover:bg-red-500 hover:text-white transition-colors"
          >
